;;; aliases.scm --- Aliases for Guile-XOSD procedures
...
;; This module provides more "Schemey" names for procedures from (xosd)
;; module.

;;; Code:

(define-module (xosd aliases)
  #:use-module (xosd))
